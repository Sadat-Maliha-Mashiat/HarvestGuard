document.addEventListener('DOMContentLoaded', function () {
  ...
  const content = {
    en: {
      ...
      feature5Heading: "Crop Health Scanner",
      feature5Description: "Scan your crops to detect diseases and health status instantly.",
      a5Button: "Scan Crop",
    ...
    bn: {
      ...
      feature5Heading: "ফসল স্বাস্থ্য স্ক্যানার",
      feature5Description: "রোগ এবং স্বাস্থ্য অবস্থা সনাক্ত করতে আপনার ফসল স্ক্যান করুন।",
      a5Button: "ফসল স্ক্যান করুন",
  ...
  function applyLanguage(lang) {
    ...
    const mapping = {
      ...
      'b1-button': 'b1Button',
      'feature5-heading': 'feature5Heading',
      'feature5-description': 'feature5Description',
      'a5-button': 'a5Button',
